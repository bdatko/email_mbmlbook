...
class TestSeedInputs:
    ...
    XML = [
        "https://raw.githubusercontent.com/dotnet/mbmlbook/main/src/4.%20Uncluttering%20Your%20Inbox/Data/Seed1Inputs.objml",
        "https://raw.githubusercontent.com/dotnet/mbmlbook/main/src/4.%20Uncluttering%20Your%20Inbox/Data/Seed2Inputs.objml",
    ]
    user_feature_set_reference = ["User35CB8E5", "User223AECA"]
    DATASETS = ["Train", "Validation", "Test"]
    SOURCE = "data/SeedInputs_objml.csv"
    ...
    def test_unique(self, column, expected, seed):
        # Arrange
        # Act
        unique_val = seed[column].unique()
        # Assert
    ...
    def test_dist_values(self, column, expected, seed):
        # Arrange
        # Act
        dist = seed[column].value_counts().to_dict()
        # Assert
